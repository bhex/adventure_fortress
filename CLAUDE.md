...
crates/fortress_core/         # pure, deterministic, fully tested
  ...
  items.rs        # ItemStock armory + per-bearer Loadout{weapon,armor,tool}; typed Item{kind,quality,enchant,condition,artifact}
