...
crates/fortress_core/         # pure, deterministic, fully tested
  ...
  items.rs        # ItemStock armory + per-bearer Loadout{weapon,armor,tool}; typed, named Item{kind,quality,enchant,condition,artifact,form,material} — ItemForm/Material name it, quality drives the rating
